...
async function loadNextStep() {
    ...
    try {
        ...
        viewport.innerHTML = `<div class="section-card"><p style="color:red;">Error: No se encontró ${nextFile}</p></div>`;
    }
}
...
async function handleStepSave(data, tableName = 'lotes') {
    ...
    try {
        ...
        if (tableName === 'infraestructura') {
            // Guardar en la tabla técnica usando el lote_id como nexo
